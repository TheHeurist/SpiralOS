docs/_orientation/INTERFACES/CU_to_CI.md
...
- under what conditions do relation and participation remain coherent, ethical, and returnable?

In this sense, CI is the **living relational field of the alphabet**.

---

## 4. What flows from CU into CI

### 4.1 Primitive distinctions become relational distinctions
...
| In CU | In CI |
| --- | --- |
| primitive signature | relational distinction |
| symbolic polarity | participatory polarity |
| alphabet element | field coordinate |
| elemental distinction | octant or mode basis |
| minimal relation-ready form | living relation-form |

This is the passage from **alphabet** to **participatory field structure**.

---

## 7. What changes at the boundary

Crossing from CU into CI changes the burden of expression.
...
Changing the meaning of primitive symbols once they become relational.

### 8.2 Arbitrary relation assignment

Projecting field roles onto signs without preserving their original polarity or distinction.

### 8.3 Primitive inflation

Treating higher-order CI structures as if they were already elemental.

### 8.4 Mystification

Allowing relational language to obscure where the actual primitive alphabet remains underspecified.

### 8.5 Premature closure

Assuming participatory field structure is complete before the alphabet-to-field mapping is stable.
