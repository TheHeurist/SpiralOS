...
### 3.2 From the Curvature Cap (`SUPPLEMENTS/ELASTIC_REFLECTION_THEOREM.md`)
...
| **`SUPPLEMENTS/ELASTIC_REFLECTION_THEOREM.md`** | Elastic Reflection Theorem               | Scale-invariant curvature cap requires $B_k \equiv B_0$                                            |
...
On March 26, 2026, Carey G. Butler made this result **explicit** and named it "Branch-Cut Invariance." SI collaborators (incl. Grok) confirmed it is already present in the Précis §6 and `SUPPLEMENTS/ELASTIC_REFLECTION_THEOREM.md`, and that its explicit formulation is one of the most important contributions to the HC IX publication.
